<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $gender = $_POST['gender'];
        $sql = "INSERT INTO `CURD`(`ID`, `F_name`, `L_name`, `area`, `email`, `contact`, `gender`) VALUES (NULL,'$F_name','$L_name','$area','$email','$contact','$gender')";
            ...
            <form action="" method="post" style="width:50vm; min-width:300px;">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="F_name" placeholder="Enter your F_name">
                    </div>

                    <div class="col">
                        <label class="form-label">L_name</label>
                        <input type="text" class="form-control" name="L_name" placeholder="Enter your L_name">
                    </div>
                </div>
